...
import com.liuyunei.common.validator.NotNullValidator;
import com.liuyunei.upms.common.constant.UpmsResult;
import com.liuyunei.upms.common.constant.UpmsResultConstant;
import com.liuyunei.upms.dao.model.*;
import com.liuyunei.upms.rpc.api.*;
...
public class UpmsUserController extends BaseController {
    ...
    public Object create(UpmsUser upmsUser) {
        ...
        Date date=new Date();
        date.toLocaleString();
        upmsUser.setCtime(date);
        System.out.println("upmsUser:"+upmsUser);
