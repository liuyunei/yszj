...
<head>
	...
	<link href="${basePath}/resources/yszj-admin/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yszj-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yszj-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yszj-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/yszj-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/*skins*/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/yszj-admin/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version"> liuyunei-yszj V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
...
<script src="${basePath}/resources/yszj-admin/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/yszj-admin/js/admin.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/yszj-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>