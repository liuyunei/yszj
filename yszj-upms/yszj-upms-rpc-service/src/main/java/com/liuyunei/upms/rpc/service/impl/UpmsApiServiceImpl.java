...
import com.liuyunei.upms.dao.mapper.*;
import com.liuyunei.upms.dao.model.*;
import com.liuyunei.upms.rpc.api.UpmsApiService;
import com.liuyunei.upms.rpc.mapper.UpmsApiMapper;
...
/**
 * UpmsApiService实现
 * Created by liuyunei on 2018/01/19.
 */
@Service
@Transactional
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "yszj-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "yszj-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
